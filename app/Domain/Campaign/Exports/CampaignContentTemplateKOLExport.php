...
class CampaignContentTemplateKOLExport implements ShouldAutoSize, WithHeadings, WithTitle, WithStyles
{
    ...
    public function headings(): array
    {
        return [
            ...
            trans('labels.dealing_upload_date'),
            trans('labels.nama_pic'),
            trans('labels.kerkun'),
            trans('labels.posting_date'),
        ];
    }
