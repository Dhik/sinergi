                ...
                <div class="card-body">
                    <form action="{{ isset($shift) ? route('shift.update', $shift->id) : route('shift.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="schedule_in" id="schedule_in" class="form-control" value="{{ isset($shift) ? $shift->schedule_in : '' }}">
                        </div>

                        <div class="form-group">
                            <label for="schedule_out">Schedule Out</label>
                            <input type="text" name="schedule_out" id="schedule_out" class="form-control" value="{{ isset($shift) ? $shift->schedule_out : '' }}">
                        </div>
